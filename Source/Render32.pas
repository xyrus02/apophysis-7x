...
//    sample_density: double;
  ...
  public
    ...
    procedure RenderMaxMem(MaxMemory: Integer = 64);
...
procedure TRenderer32.RenderMaxMem(MaxMemory: Integer);
begin
end;


procedure TRenderer32.Render(Time: double);
begin
end;

procedure TRenderer32.SetCP(CP: TControlPoint);
begin
  FCP := CP;
end;

procedure TRenderer32.SetOnProgress(const Value: TOnProgress);
begin
  FOnProgress := Value;
end;
...
begin
  ...
  for i := 0 to nrbatches do begin
    ...
    if (i and $FF = 0) and assigned(FOnProgress) then
