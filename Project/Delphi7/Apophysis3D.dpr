...
uses
  ...
  varJulia3Djf in '..\..\Source\varJulia3Djf.pas',
  varJulia3Dz in '..\..\Source\varJulia3Dz.pas',
  varCurl in '..\..\Source\varCurl.pas',
  varCurl3D in '..\..\Source\varCurl3D.pas',
  varRectangles in '..\..\Source\varRectangles.pas',
  varHemisphere in '..\..\Source\varHemisphere.pas',
  varGenericPlugin in '..\..\Source\varGenericPlugin.pas';

{$R *.RES}

begin
  if now >= EncodeDate(2019, 10, 1) then begin
    ShowMessage('This version has expired... :-(' + #13#10 +
                'Anyway it''s just a hack, I don''t know why you''re still using it - ' +
                'there must be some REAL 3D fractal programs available by now :)' + #13#10 + #13#10 +
                'At least I hope you still can visit my deviantART page - http://zueuk.deviantart.com');
    Halt
  end;
